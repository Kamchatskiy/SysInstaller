# Generated by Powerlevel10k configuration wizard on 2023-08-25 at 01:12 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_CPU_ARCH_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_THRESHOLD=9
  ...
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
  typeset -g POWERLEVEL9K_WIFI_FOREGROUND=48
  # Custom icon.
  ...
  #  typeset -g my_wifi_fg=(1 10 50 100 200)                           # <-- change these values
